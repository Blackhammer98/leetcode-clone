        ...
        <CardContent className="p-6">
          ...
          >
            ...
            <div className="flex flex-col space-y-4 mb-6">
              ...
              <div className="flex gap-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-lg w-fit border">
            ...
            {/* --- 2. Dynamic Content (Only renders editors for the activeLang) --- */}
            <Card
              key={activeLang}
              className="bg-slate-50 dark:bg-slate-950/20 border-2 border-amber-100/50"
            >
              ...
              <CardContent className="p-6 space-y-8">
                ...
                <div className="space-y-4">
                  <Label className="text-lg font-medium flex items-center gap-2">
                    <FileText className="w-4 h-4 text-slate-500" /> Starter Code
                    Template
                  </Label>
                  <Controller
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Textarea
                        ...
                        className="mt-2 min-h-20 font-mono bg-white dark:bg-slate-900"
                      />
                    </div>
                    <div>
                      <Label className="text-xs uppercase text-slate-500 font-bold">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Explain how this language handles this specific case..."
                        className="mt-2 min-h-24 bg-white dark:bg-slate-900"
                      />
                    </div>
                  </div>
                </div>
